...
namespace WindowsGSM.Plugins
{
    public class Satisfactory : SteamCMDAgent
    {
        ...
        {
            name = "WindowsGSM.Satisfactory.Experimental", // WindowsGSM.XXXX
            author = "werewolf2150",
            description = "WindowsGSM plugin for supporting Satisfactory Dedicated Server Experimental",
            version = "1.3",
        ...
        public string FullName = "Satisfactory Dedicated Server Expérimental"; // Game server FullName
